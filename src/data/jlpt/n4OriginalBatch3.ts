...
export const N4_ORIGINAL_BATCH3: JlptQuestion[] = [
  // ── jpg_sou-appearance ──
  {
    ...
    type: 'single', score: 1,
    stem: 'あの 人が もう 帰る したくを して います。となりの せきが （　　）です。',
  ...
  },
  {
    ...
    answer: '1',
    explain: '正解：<b>も いいですか</b>。B 回答「どうぞ」＝<b>給予許可</b>，所以 A 問的一定是<b>「我可以用嗎」</b>。<br>誘答：<b>もらえますか</b> 會變成請對方幫忙用椅子，語意不通；<b>は いけませんか</b> 是在問「不可以嗎」，語氣是抗議或確認禁止，接「どうぞ」不順；<b>いませんか</b> 是確認對方沒在用，雖然日常也會這樣問，但那是在<b>確認狀態</b>而不是<b>請求許可</b>，和「どうぞ、使って ください」的回應對不上。<br><b>解題順序：先看回答</b>——回答是「どうぞ」（許可）就往てもいいですか 想。',
    source: { book: 'JLPT N4', chapter: '動詞', level: 'N4', confirmed: false, license: 'own', origin: 'own' },
    topics: { primary: 'jpg_te-moraemasu-request', topicIds: ['jpg_te-moraemasu-request'] },
  },
  ...
  // ── jpg_kureru-direction ──
  {
    ...
    answer: '1',
    explain: '正解：<b>くれた</b>。主語是「そふ<b>が</b>」、接受方是「わたし<b>に</b>」——<b>別人給我</b>，這個方向只能用くれる。<br>誘答：<b>もらった</b> 的主語必須是接受的一方（私が そふ<b>に／から</b> もらった），這裡主語是そふ、又接「わたしに」，助詞對不上；<b>あげた／やった</b> 是「給出去」，但<b>不能以說話者自己為接受方</b>——「そふが わたしに あげた」是不成立的說法。<br>三個方向記牢：<b>あげる＝我→人</b>、<b>もらう＝人→我（我當主語）</b>、<b>くれる＝人→我（對方當主語）</b>。',
    source: { book: 'JLPT N4', chapter: '動詞', level: 'N4', confirmed: false, license: 'own', origin: 'own' },
  ...
  },
  {
    ...
    type: 'single', score: 1,
    stem: '日本語の さくぶんが よく わからなかったので、わたしは 友だちに 教えて （　　）ました。',
  ...
  // ── jpg_tara-conditional ──
  {
    ...
    answer: '1',
    explain: '正解：<b>行ったら</b>。たら 的變化規則和<b>た形完全相同</b>——先變た形（行く→行っ<b>た</b>），再把た 換成<b>たら</b>。<br>誘答各對應一種錯法：<b>行くたら</b> 接了辭書形；<b>行きたら</b> 接了ます形語幹；<b>行っだら</b> 濁化錯誤——た 要變だ 只發生在ん・び・み 結尾的音便後（飲ん<b>だ</b>ら・遊ん<b>だ</b>ら），促音「っ」後面一律用た。<br>只要た形會變，たら 就不用另外背：<b>飲む→飲んだ→飲んだら</b>、<b>見る→見た→見たら</b>、<b>する→した→したら</b>。',
    source: { book: 'JLPT N4', chapter: '文の構造', level: 'N4', confirmed: false, license: 'own', origin: 'own' },
  ...
  // ── jpr_passage-theme-synthesis（同一篇短文配三題）──
  {
    ...
    type: 'single', score: 1,
    stem: '［つぎの 文章を 読んで、こたえて ください］<br><br>せんしゅう、雨の 日に かさを わすれて こまって いました。すると、店の 人が 古い かさを かして くれました。つぎの日 かえしに 行って お礼を 言うと、その 人は 「いいですよ」と わらって 言いました。わたしも いつか、こまって いる 人に 同じ ことを して あげたいと 思いました。<br><br><b>問：この 文章で いちばん つたえたい ことは 何ですか。</b>',
    options: [
  ...
  },
  {
    ...
    type: 'single', score: 1,
    stem: '［前の 文章に ついて］<br><br>せんしゅう、雨の 日に かさを わすれて こまって いました。すると、店の 人が 古い かさを かして くれました。つぎの日 かえしに 行って お礼を 言うと、その 人は 「いいですよ」と わらって 言いました。わたしも いつか、こまって いる 人に 同じ ことを して あげたいと 思いました。<br><br><b>問：この 文章の さいごに 入れるのに いちばん いい 文は どれですか。</b>',
    options: [
  ...
  },
  {
    ...
    type: 'single', score: 1,
    stem: '［前の 文章に ついて］<br><br>せんしゅう、雨の 日に かさを わすれて こまって いました。すると、店の 人が 古い かさを かして くれました。つぎの日 かえしに 行って お礼を 言うと、その 人は 「いいですよ」と わらって 言いました。わたしも いつか、こまって いる 人に 同じ ことを して あげたいと 思いました。<br><br><b>問：かさを かしたのは だれですか。</b>',
