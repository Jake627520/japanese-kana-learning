...
export const N4_ORIGINAL_BATCH3: JlptQuestion[] = [
  // ── jpg_sou-appearance ──
  {
    ...
    type: 'single', score: 1,
    stem: 'となりの 人は もう 帰る じゅんびを して います。せきが （　　）です。',
  ...
  // ── jpr_passage-theme-synthesis（同一篇短文配三題）──
  {
    ...
    answer: '1',
    explain: '正解：<b>「人に しんせつに して もらった けいけんから、自分も そう したいと 思った」</b>。文章的<b>核心事件</b>是「受到陌生人幫助」，<b>情緒轉折</b>落在最後一句「自分も 同じ ことを して あげたい」——主旨就在這兩者的連線上。<br>誘答的共通問題是<b>只抓到某一句的細節，沒有跳出來看整篇</b>：<br>・「古い かさは あたらしい かさより べんりだ」——文章沒有比較新舊傘；<br>・「雨の 日には かさを わすれない ほうが いい」——雖然開頭提到忘了帶傘，但那是事件的起點不是重點；<br>・4 「いつも わらって いる」與原文不符——文章裡那個人只笑過那一次。<br>主旨題的作法：<b>先用一句話說出「發生了什麼＋心情怎麼變」，再看哪個選項符合這條線。</b>',
    source: { book: 'JLPT N4', chapter: '読解', level: 'N4', confirmed: false, license: 'own', origin: 'own' },
