...
export const N5_ORIGINAL_BATCH4: JlptQuestion[] = [
  ...
  // ── jpv_rendaku（連濁）──
  {
    ...
    options: ['連濁で 「か」が 「が」に なるから', 'ひらがなだけ とくべつだから', 'かなは いつも 「がな」だから', 'まちがいだから'],
    answer: '1',
  ...
  },
  {
    ...
    options: ['て＋かみ → てがみ', 'たか＋い → たかい', 'やま＋みち → やまみち', 'あか＋い → あかい'],
    answer: '1',
  ...
  },
  {
    ...
    options: ['あさと よるの あいだ', 'ねる とき', 'あさの まえ', 'よるの あと'],
    answer: '1',
