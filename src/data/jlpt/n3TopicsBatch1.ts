...
export const N3_TOPICS_BATCH1: JlptTopic[] = [
  ...
  { id: 'jpg_n3-tame-ni', type: 'grammar', subject: '日本語', domain: '文法',
    ...
    description: '書面語的客觀原因（事故のために電車が止まった）。與表示目的的ために同形，判準看前件的性質：前面是事件或狀態→原因；是想達成的目標或受益的人／團體→目的。人＋のために 一律是「為了某人」，不表原因。',
    evidence: ['能依前件性質判斷ために表原因還是目的', '知道人＋のために 一律是「為了某人」，不表原因'] },
