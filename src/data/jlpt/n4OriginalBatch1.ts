...
export const N4_ORIGINAL_BATCH1: JlptQuestion[] = [
  ...
  },
  {
    ...
    answer: '1',
    explain: '正解：<b>美しかった</b>。<b>景色＋美しい</b> 是固定的搭配——講風景的美，日文用「美しい」而不是別的形容詞。<br>誘答：<b>楽しい</b> 形容的是「活動讓人開心」，風景本身不會楽しい；<b>うるさい</b>（吵）是聽覺，與看到的景色無關；<b>優しい</b> 用來形容人的性格。<br>這一類題四個選項的<b>形態全部正確</b>（都是い形容詞的過去形），考的純粹是<b>哪個詞配得上這個名詞</b>——所以解題時要問的是搭配，不是活用。',
    source: { book: 'JLPT N4', chapter: '語彙', level: 'N4', confirmed: false, license: 'own', origin: 'own' },
    topics: { primary: 'jpv_n4-i-adjectives', topicIds: ['jpv_n4-i-adjectives'] },
  },
  {
  ...
  },
  {
    ...
    answer: '1',
    explain: '正解：<b>だんだん</b>。<b>だんだん 配「〜くなってきました」這種逐漸的變化</b>——天氣一天比一天暖。<br>誘答：<b>もうすぐ</b>（快要）講的是<b>還沒發生</b>的事，和已經在發生的「なって きました」時間軸衝突；<b>ぜひ</b> 配請求或願望（ぜひ 来て ください）；<b>なかなか</b> 後面必須接否定。<br>整組副詞的判斷依據都是<b>句尾的形式</b>：てください→ぜひ、否定→なかなか、〜た（實現）→やっと、〜てきました（漸變）→だんだん、〜でしょう（推測）→きっと。',
    source: { book: 'JLPT N4', chapter: '副詞', level: 'N4', confirmed: false, license: 'own', origin: 'own' },
    topics: { primary: 'jpg_n4-adverbs', topicIds: ['jpg_n4-adverbs'] },
  },
