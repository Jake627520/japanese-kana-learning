...
export const N4_ORIGINAL_BATCH2: JlptQuestion[] = [
  ...
  },
  {
    ...
    options: ['に', 'を', 'が', 'で'],
    answer: '1',
    explain: '正解：<b>に</b>。<b>這題是上一題的例外情況，要成對記</b>。<br>「飲む」本身就是他動詞，句子裡已經有一個を（くすり<u>を</u>）。這時使役的對象<b>必須改標に</b>，避免一句話出現兩個を——「私を くすりを 飲ませた」是不成立的。<br>誘答：<b>を</b> 就是這個錯誤；<b>が</b> 會讓「私」變成主語，但主語是母；<b>で</b> 標手段或場所。<br>整理成三種情況——判準是<b>使役動詞本身的補語</b>（同一個動詞底下），不是整句有沒有出現過を：<br>・<b>他動詞句</b>（動詞本身已帶を：くすり<u>を</u> 飲ませる）→ 對象只能用<b>に</b>，避免同一個動詞帶兩個を；<br>・<b>情緒動詞</b>（心配させる・困らせる・喜ばせる）→ 固定用<b>を</b>；<br>・<b>自動詞句</b>（行かせる・遊ばせる）→ を／に 都可以，<b>を 偏強制</b>、<b>に 偏允許放任</b>（子どもを 行かせる／子どもに 行かせる）。<br>注意「同一個動詞底下」這個限定：上一題的「けがを して、両親を 心配させました」整句裡雖然出現過を，但那個を 屬於「けがをする」，和「心配させる」不同動詞，所以不受影響。',
    source: { book: 'JLPT N4', chapter: '動詞', level: 'N4', confirmed: false, license: 'own', origin: 'own' },
    topics: { primary: 'jpg_causative', topicIds: ['jpg_causative'] },
  },
