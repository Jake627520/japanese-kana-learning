...
export const VOCABULARY_AUDIO_MAPPING: Record<string, string> = {
  ...
  vocab_k_kyou: 'キョウ',
  vocab_k_gyagu: 'ギャグ',
  vocab_k_gyuuniku: 'ギュウニク',
  vocab_k_gyouza: 'ギョーザ',
  vocab_k_shatsu_sha: 'シャツ',
  vocab_k_shuuzu: 'シューズ',
  vocab_k_shoppingu: 'ショッピング',
  vocab_k_jazu: 'ジャズ',
  vocab_k_juusu_ju: 'ジュース',
  vocab_k_jogingu: 'ジョギング',
  vocab_k_chansu: 'チャンス',
  vocab_k_chuurippu: 'チューリップ',
  vocab_k_choko: 'チョコ',
  vocab_k_nyaa: 'ニャー',
  vocab_k_nyuusu_nyu: 'ニュース',
  vocab_k_nyokinyoki: 'ニョキニョキ',
  vocab_k_hyaku: 'ヒャク',
  vocab_k_hyuu: 'ヒュー',
  vocab_k_hyou: 'ヒョウ',
  vocab_k_byakuya: 'ビャクヤ',
  vocab_k_byuu: 'ビュー',
  vocab_k_byouin: 'ビョウイン',
  vocab_k_pya: 'ピャッ',
  vocab_k_pyua: 'ピュア',
  vocab_k_pyon: 'ピョン',
  vocab_k_myaku: 'ミャク',
  vocab_k_myuujikku: 'ミュージック',
  vocab_k_myouji: 'ミョウジ',
  vocab_k_ryaku: 'リャク',
  vocab_k_ryukku: 'リュック',
  vocab_k_ryokou: 'リョコウ',
